...
var resumeString = "<img src='images/resumeThumbnail.png' class='resumeThumbnail'><div class='downloadSpace'><div class='pdfname'><img src='images/pdf.png'><label>Mark_Culambot_Resume.pdf</label></div><a href='assets/Mark_Renzkie_Culambot_Resume.pdf' download='Mark_Renzkie_Culambot_Resume.pdf'><img class='download' src='images/downloadIcon.svg'></a></div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️This portfolio website is built using HTML, CSS and JavaScript<br><br> 🎨Designed and Developed by <a class='alink' target='_blank' href='https://github.com/ZenkieCasanova'><span class='bold'>Mark Renzkie Culambot</a></span>");
            break;
        case "contact":
            sendTextMessage("Contact Info: <br><br>Cellphone Number: +639499223803");
            break;
        case "projects":
            sendTextMessage("You want to check my projects? Then please click into my Github Account.<br><br><div class='social'><a target='_blank' href='https://github.com/ZenkieCasanova'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a></div>");
            break;
        case "new":
            sendTextMessage(addressString);
            break;
        default:
            setTimeout(() => {
                sendTextMessage("Hello, I apologize the time for response has ran out...😢<br>Send/Chat 'help' to know more about usage.");
            }, 2000);
            break;
    }
}
